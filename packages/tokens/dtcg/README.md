...
- `tokens`: Contains the list of all the design tokens, and how they're combined
  - `base`: Contains all the names and values available as design tokens
  ...
  - `themes`: Contains the list of themes: it's a list of tokens that are used to **globally** style the interface (ex: "light" or "dark").
  - `variants`: Contains the list of variants: it's a list of tokens that are used to **locally** style an component or element (ex: "button.small" or "button.primary").
