...
import { colorDesignTokensCollectionTokenToColorFigmaDesignToken } from './dtcg/types/base/color.ts';
import { cubicBezierDesignTokensCollectionTokenToCubicBezierFigmaDesignToken } from './dtcg/types/base/cubic-bezier.ts';
import { dimensionDesignTokensCollectionTokenToNumberFigmaDesignToken } from './dtcg/types/base/dimension.ts';
import { durationDesignTokensCollectionTokenToNumberFigmaDesignToken } from './dtcg/types/base/duration.ts';
import { fontFamilyDesignTokensCollectionTokenToStringFigmaDesignToken } from './dtcg/types/base/font-family.ts';
import { fontWeightDesignTokensCollectionTokenToNumberFigmaDesignToken } from './dtcg/types/base/font-weight.ts';
import { numberDesignTokensCollectionTokenToNumberFigmaDesignToken } from './dtcg/types/base/number.ts';
import { borderDesignTokensCollectionTokenToFigmaDesignTokensGroup } from './dtcg/types/composite/border.ts';
import { gradientDesignTokensCollectionTokenToFigmaDesignTokensGroup } from './dtcg/types/composite/gradient.ts';
import { shadowDesignTokensCollectionTokenToFigmaDesignTokensGroup } from './dtcg/types/composite/shadow.ts';
import { strokeStyleDesignTokensCollectionTokenToStringFigmaDesignToken } from './dtcg/types/composite/stroke-style.ts';
import { transitionDesignTokensCollectionTokenToFigmaDesignTokensGroup } from './dtcg/types/composite/transition.ts';
import { typographyDesignTokensCollectionTokenToFigmaDesignTokensGroup } from './dtcg/types/composite/typography.ts';
