...
- **Content:** Focus on *what* changed and *why* it matters to the user, not *how* it was implemented. (e.g., Use "Fixed a crash when loading large images" instead of "Refactored image processing loop to use async iterators").
