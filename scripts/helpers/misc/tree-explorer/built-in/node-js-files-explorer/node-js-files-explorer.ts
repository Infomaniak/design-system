...
export class NodeJsFilesExplorer extends AsyncTreeExplorer<NodeJsFilesExplorerInput, FileEntry> {
  constructor() {
    super(
      async function* readDirectory(
        fileEntry: FileEntry,
      ): AsyncGenerator<NodeJsFilesExplorerInput> {
...
export const NODE_JS_FILES_EXPLORER = new NodeJsFilesExplorer();
