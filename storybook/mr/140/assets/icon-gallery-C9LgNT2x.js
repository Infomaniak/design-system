import{a as e,n as t}from"./chunk-DnJy8xQt.js";import{r as n}from"./react-pwy5RQoA.js";import{D as r,E as i,F as a,T as o,_ as s,a as c,o as l,v as u}from"./iframe-BroWjMgJ.js";import{t as d}from"./mdx-react-shim-DPu4Xs5y.js";var f,p=t((()=>{o(),f=new i({resources:[`https://iconify.preprod.dev.infomaniak.ch/`]})})),m,h=t((()=>{m={ABORTED:`ABORTED`,API_ERROR:`API_ERROR`,NETWORK_ERROR:`NETWORK_ERROR`,TIMEOUT:`TIMEOUT`,UNKNOWN_ERROR:`UNKNOWN_ERROR`,BOUNDARY_ERROR:`BOUNDARY_ERROR`}}));function ee(e){return{name:e.name,categories:e.categories}}function g(e){return e instanceof Error?{message:e.message,code:e.name===`AbortError`?m.ABORTED:m.API_ERROR}:{message:`An unknown error occurred`,code:m.UNKNOWN_ERROR}}function _(e=f){let t=(0,v.useRef)(null),n=(0,v.useRef)(null),[r,i]=(0,v.useState)([]),[a,o]=(0,v.useState)(``),[s,c]=(0,v.useState)([]),[l,u]=(0,v.useState)(0),[d,p]=(0,v.useState)(``),[m,h]=(0,v.useState)(``),[_,y]=(0,v.useState)(!1),[b,x]=(0,v.useState)(!1),[ne,S]=(0,v.useState)(null),C=_||b,w=(0,v.useCallback)(()=>{t.current!==null&&(t.current.abort(),t.current=null)},[]),T=(0,v.useCallback)(e=>{p(e),n.current!==null&&clearTimeout(n.current),n.current=setTimeout(()=>{h(e.trim().toLowerCase())},te)},[]),E=(0,v.useCallback)(async t=>{try{y(!0),S(null);let n=await e.listIconSets({signal:t}),r=Object.keys(n).sort();i(r),r.length>0&&o(r[0])}catch(e){if(t.aborted)return;S(g(e))}finally{y(!1)}},[e]),D=(0,v.useCallback)(async(t,n)=>{try{u((await e.search({prefix:t,query:``,signal:n})).length)}catch{}},[e]),O=(0,v.useCallback)(async(n,r,i)=>{try{x(!0),S(null),c((await e.search({prefix:n,query:r,signal:i})).map(ee))}catch(e){if(i.aborted)return;S(g(e))}finally{x(!1),t.current?.signal===i&&(t.current=null)}},[e]);(0,v.useEffect)(()=>{let e=new AbortController;return E(e.signal),()=>{e.abort()}},[E]),(0,v.useEffect)(()=>{if(a===``)return;w();let e=new AbortController;return t.current=e,D(a,e.signal),O(a,m,e.signal),()=>{e.abort()}},[a,m,D,O,w]);let k=(0,v.useCallback)(e=>{o(e),p(``),h(``)},[]),A=(0,v.useCallback)(()=>{p(``),h(``),n.current!==null&&(clearTimeout(n.current),n.current=null)},[]),re=(0,v.useCallback)(()=>{if(r.length===0){w();let e=new AbortController;t.current=e,E(e.signal)}else if(a!==``){w();let e=new AbortController;t.current=e,D(a,e.signal),O(a,m,e.signal)}},[r.length,a,m,E,D,O,w]);return(0,v.useEffect)(()=>()=>{w(),n.current!==null&&clearTimeout(n.current)},[w]),{collections:r,icons:s,totalCount:l,filteredCount:s.length,selectedCollection:a,searchQuery:d,isLoading:C,isLoadingCollections:_,isLoadingIcons:b,error:ne,setCollection:k,setSearchQuery:T,retry:re,clearSearch:A}}var v,te,y=t((()=>{o(),v=e(a(),1),p(),h(),te=300}));function b(){try{return typeof window>`u`||!window.parent?null:new URL(window.parent.location.href)}catch{return null}}function x(e){let t=b();return t?t.searchParams.get(e):null}function ne(e){let t=b();if(!t)return;Object.entries(e).forEach(([e,n])=>{n===null||n===``?t.searchParams.delete(e):t.searchParams.set(e,n)});let n=t.search,r=t.toString().split(`?`)[0]+n.replace(/%2F/g,`/`);window.parent.history.replaceState(null,``,r)}function S(){let e=_(f),{collections:t,selectedCollection:n,searchQuery:r,setCollection:i,setSearchQuery:a}=e,[o,s]=(0,C.useState)(!1),c=(0,C.useRef)(null),l=(0,C.useRef)({search:``,collection:``});(0,C.useEffect)(()=>{if(o||t.length===0)return;let e=x(T),n=x(w);e&&t.includes(e)&&i(e),n&&a(n),s(!0)},[t,o,i,a]);let u=(0,C.useCallback)((e,t)=>{l.current.search===e&&l.current.collection===t||(l.current={search:e,collection:t},ne({[w]:e||null,[T]:t||null}))},[]);return(0,C.useEffect)(()=>{if(o)return c.current&&clearTimeout(c.current),c.current=setTimeout(()=>{u(r,n)},E),()=>{c.current&&clearTimeout(c.current)}},[r,n,o,u]),(0,C.useEffect)(()=>()=>{c.current&&clearTimeout(c.current)},[]),e}var C,w,T,E,D=t((()=>{C=e(a(),1),p(),y(),w=`search`,T=`collection`,E=100})),O,k,A,re=t((()=>{O=e(a(),1),k=s(),A=({collections:e,selected:t,onChange:n,disabled:r=!1})=>{let i=e=>{n(e.target.value)},a=O.useMemo(()=>[...e].sort((e,t)=>e.localeCompare(t)),[e]);return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`style`,{children:`
      ...
      `}),(0,I.jsxs)(`div`,{className:`icon-card`,onClick:i,role:`button`,tabIndex:0,onKeyDown:e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),i())},children:[(0,I.jsx)(`div`,{className:`icon-card__icon`,children:(0,I.jsx)(`esds-icon`,{name:r,mode:`bg`,style:{width:`48px`,height:`48px`}})}),(0,I.jsx)(`code`,{className:`icon-card__code`,children:r})]})]})},L.__docgenInfo={description:``,methods:[],displayName:`IconCard`,props:{icon:{required:!0,tsType:{name:`IconItem`},description:``},prefix:{required:!0,tsType:{name:`string`},description:``},onClick:{required:!1,tsType:{name:`signature`,type:`function`,raw:`(icon: IconItem) => void`,signature:{arguments:[{type:{name:`IconItem`},name:`icon`}],return:{name:`void`}}},description:``}}}})),R,z,ue,B,de=t((()=>{R=e(a(),1),z=s(),ue=1500,B=({value:e,label:t,children:n,className:r=``,size:i=`sm`})=>{let[a,o]=(0,R.useState)(`idle`),[s,c]=(0,R.useState)(!1),[l,u]=(0,R.useState)({x:0,y:0}),d=(0,R.useRef)(null),f=(0,R.useRef)(null);(0,R.useEffect)(()=>()=>{d.current&&clearTimeout(d.current)},[]);let p=(0,R.useCallback)(async t=>{let n=t.currentTarget.getBoundingClientRect();u({x:n.left+n.width/2,y:n.top-8});try{await navigator.clipboard.writeText(e),o(`copied`)}catch{o(`failed`)}d.current&&clearTimeout(d.current),d.current=setTimeout(()=>{o(`idle`)},ue)},[e]),m=(0,R.useCallback)(e=>{let t=e.currentTarget.getBoundingClientRect();u({x:t.left+t.width/2,y:t.top-8}),c(!0)},[]),h=(0,R.useCallback)(()=>{c(!1)},[]);return(0,z.jsxs)(z.Fragment,{children:[(0,z.jsx)(`style`,{children:`
        .copyable-text {
          display: inline-flex;
          align-items: center;
          gap: 8px;
      ...
      `}),(0,K.jsx)(`div`,{className:`icon-grid`,children:e.map(e=>(0,K.jsx)(L,{icon:e,prefix:t,onClick:o},`${t}:${e.name}`))}),(0,K.jsx)(pe,{icon:n,isOpen:i,prefix:t,onClose:s})]})},q.__docgenInfo={description:``,methods:[],displayName:`IconGrid`,props:{icons:{required:!0,tsType:{name:`unknown`},description:``},prefix:{required:!0,tsType:{name:`string`},description:``}}}})),J,Y,_e=t((()=>{a(),J=s(),Y=({value:e,onChange:t,placeholder:n=`Search icons by name...`,disabled:r=!1,onClear:i})=>{let a=e=>{t(e.target.value)},o=()=>{i()},s=e.length>0;return(0,J.jsxs)(J.Fragment,{children:[(0,J.jsx)(`style`,{children:`
        .icon-search-bar {
          position: relative;
          display: flex;
          align-items: center;
      ...
      `}),(0,J.jsxs)(`div`,{className:`icon-search-bar`,children:[(0,J.jsxs)(`svg`,{width:`20`,height:`20`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,className:`icon-search-bar__icon`,children:[(0,J.jsx)(`circle`,{cx:`11`,cy:`11`,r:`8`}),(0,J.jsx)(`line`,{x1:`21`,y1:`21`,x2:`16.65`,y2:`16.65`})]}),(0,J.jsx)(`input`,{type:`text`,value:e,onChange:a,placeholder:n,disabled:r,className:`icon-search-bar__input`}),s&&!r&&(0,J.jsx)(`button`,{type:`button`,onClick:o,className:`icon-search-bar__clear`,"aria-label":`Clear search`,children:(0,J.jsxs)(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,children:[(0,J.jsx)(`line`,{x1:`18`,y1:`6`,x2:`6`,y2:`18`}),(0,J.jsx)(`line`,{x1:`6`,y1:`6`,x2:`18`,y2:`18`})]})})]})]})},Y.__docgenInfo={description:``,methods:[],displayName:`IconSearchBar`,props:{value:{required:!0,tsType:{name:`string`},description:``},onChange:{required:!0,tsType:{name:`signature`,type:`function`,raw:`(value: string) => void`,signature:{arguments:[{type:{name:`string`},name:`value`}],return:{name:`void`}}},description:``},placeholder:{required:!1,tsType:{name:`string`},description:``,defaultValue:{value:`'Search icons by name...'`,computed:!1}},disabled:{required:!1,tsType:{name:`boolean`},description:``,defaultValue:{value:`false`,computed:!1}},onClear:{required:!0,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``}}}})),X,ve,ye=t((()=>{a(),D(),re(),ie(),oe(),se(),ge(),_e(),X=s(),ve=()=>{let{collections:e,icons:t,totalCount:n,filteredCount:r,selectedCollection:i,searchQuery:a,isLoading:o,isLoadingCollections:s,error:c,setCollection:l,setSearchQuery:u,retry:d,clearSearch:f}=S(),p=e=>{l(e)},m=e=>{u(e)},h=()=>{f()},ee=()=>{d()},g=()=>s?(0,X.jsxs)(`div`,{className:`icon-gallery__loading`,children:[(0,X.jsx)(F,{}),(0,X.jsx)(`p`,{className:`icon-gallery__loading-text`,children:`Loading collections...`})]}):o?(0,X.jsx)(F,{}):c===null?t.length===0?(0,X.jsx)(M,{searchQuery:a,onClearSearch:a.length>0?h:void 0}):(0,X.jsx)(q,{icons:t,prefix:i}):(0,X.jsx)(ae,{error:c,onRetry:ee}),_=o||c!==null;return(0,X.jsxs)(X.Fragment,{children:[(0,X.jsx)(`style`,{children:`
        .icon-gallery {
          padding: 1.5rem;
        }
      ...
      `}),(0,X.jsxs)(`div`,{className:`icon-gallery`,children:[(0,X.jsxs)(`div`,{className:`icon-gallery__header`,children:[(0,X.jsxs)(`div`,{className:`icon-gallery__title-row`,children:[(0,X.jsx)(`h1`,{className:`icon-gallery__title`,children:`Icon Gallery`}),(0,X.jsxs)(`span`,{className:`icon-gallery__count`,children:[`Showing `,r,` of `,n,` icons`]})]}),(0,X.jsx)(`div`,{className:`icon-gallery__controls-wrapper`,children:(0,X.jsxs)(`div`,{className:`icon-gallery__controls`,children:[(0,X.jsx)(`div`,{className:`icon-gallery__search`,children:(0,X.jsx)(Y,{value:a,onChange:m,disabled:_,onClear:h})}),(0,X.jsx)(`div`,{className:`icon-gallery__filter`,children:(0,X.jsx)(A,{collections:e,selected:i,onChange:p,disabled:_})})]})})]}),(0,X.jsx)(`div`,{children:g()})]})]})},ve.__docgenInfo={description:``,methods:[],displayName:`IconGallery`}})),be,Z,Q,xe,Se=t((()=>{be=e(a(),1),Z=s(),Q={message:`An unexpected error occurred in the icon gallery`,code:`BOUNDARY_ERROR`},xe=class extends be.Component{state={hasError:!1,error:null};static getDerivedStateFromError(e){return{hasError:!0,error:{message:e.message||Q.message,code:e.name===`AbortError`?`ABORTED`:Q.code}}}componentDidCatch(e,t){console.error(`IconGalleryErrorBoundary caught an error:`,e,t)}render(){return this.state.hasError?this.props.fallback?this.props.fallback:(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsx)(`style`,{children:`
