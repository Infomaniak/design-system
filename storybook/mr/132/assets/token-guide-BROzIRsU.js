import{a as e,en as t,s as n,yt as r}from"./iframe-HZdl1vId.js";var i=t(r());function a(t){let r={a:`a`,br:`br`,code:`code`,div:`div`,em:`em`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...t.components},{Table:a}=r;return a||s(`Table`,!0),(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(e,{title:`Design Tokens/Getting Started`}),`
...
`,(0,i.jsx)(r.h4,{id:`installation`,children:`Installation`}),`
`,(0,i.jsx)(r.p,{children:`...
Swift Package Manager — via Xcode or Package.swift :`}),`
`,(0,i.jsx)(r.pre,{children:(0,i.jsx)(r.code,{className:`language-swift`,children:`swift.package(url: "https://github.com/Infomaniak/ios-design-system", branch: "main")
swift.target(
    name: "MyTarget",
    dependencies: [
...
`})}),`
`,(0,i.jsx)(r.p,{children:(0,i.jsx)(r.em,{children:`Supported platforms: iOS 16+, macOS 13+, visionOS 1+`})}),`
`,(0,i.jsx)(r.h3,{id:`package-structure`,children:`Package structure`}),`
`,(0,i.jsx)(r.pre,{children:(0,i.jsx)(r.code,{children:`CatalogApp/               ← Demo app
Sources/DesignSystem/     ← Tokens, SwiftUI components
Tests/DesignSystemTests/  ← Unit tests
`})}),`
`,(0,i.jsx)(r.h2,{id:`usage`,children:`Usage`}),`
`,(0,i.jsx)(r.h4,{id:`configure-environment`,children:`Configure environment`}),`
`,(0,i.jsx)(r.pre,{children:(0,i.jsx)(r.code,{className:`language-swift`,children:`import DesignSystem

// Get theme via environment variable
@Environment(\\.esdsTheme) var theme
`})}),`
`,(0,i.jsxs)(r.h4,{id:`access-tokens-in-swiftui`,children:[`Access tokens in `,(0,i.jsx)(r.strong,{children:`SwiftUI`})]}),`
`,(0,i.jsx)(r.pre,{children:(0,i.jsx)(r.code,{className:`language-swift`,children:`struct ContentView: View {
    @Environment(\\.esdsTheme) var theme
...
`})}),`
`,(0,i.jsx)(r.h4,{id:`set-theme`,children:`Set theme`}),`
`,(0,i.jsx)(r.pre,{children:(0,i.jsx)(r.code,{className:`language-swift`,children:`// In your app
@main
struct MyApp: App {
    var body: some Scene {
        WindowGroup {
...
`})}),`
`,(0,i.jsx)(r.p,{children:`T3-Component  →  button.background.error
↓
