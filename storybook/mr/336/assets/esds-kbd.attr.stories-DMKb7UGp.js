...
`})))()}var h;function g(){return(g=e((()=>{h=`kbd[esds-kbd]{box-sizing:border-box;padding:var(--esds-kbd-padding-block) var(--esds-kbd-padding-inline);background-color:var(--esds-kbd-background-color);border:var(--esds-kbd-border-width) solid var(--esds-kbd-border-color);border-radius:var(--esds-kbd-border-radius);color:var(--esds-kbd-content-color);font:var(--esds-kbd-font)}`})))()}var _,v;function y(){return(y=e((()=>{c(),a(),g(),_=f.parse(h),v=class e extends o{static define({registry:t=u.root}={}){t.defineOptionally(`esds-kbd`,e)}#e;constructor(e){if(e.ownerElement?.tagName!==`KBD`)throw Error(`esds-kbd attribute can only be used on <kbd> elements`);super(e)}connectedCallback(){this.#e=_.injectFrom(this.ownerElement)}disconnectedCallback(){this.#e?.(),this.#e=void 0}}})))()}var b,x,S,C,w,T,E,D;function O(){return(O=e((()=>{n(),i(),d(),a(),m(),y(),b=l(e=>{v.define({registry:u.of(e.ownerDocument)})}),{args:x,argTypes:S}=r(`esds-kbd`),C={title:`Components/Kbd`,component:`esds-kbd`,tags:[`autodocs`,`vr-test`],parameters:{docs:{description:{component:p}}},args:x,argTypes:S},w={...s({text:`K`}),render:e=>t`<p>
      ...
      >
      to open the search.
    </p>`},T={parameters:{docs:{description:{story:"Multi-key shortcuts are a single `<kbd esds-kbd>` element containing the full combination, e.g. `⌘+K`."}}},render:()=>t`
    <p>
      Press
      <kbd
        ${b}
  ...
  `},E={parameters:{docs:{description:{story:`Modifier and special keys are plain Unicode characters typed literally in the markup — the attribute applies no mapping. Copy the glyph you need from the canvas, or the ready-to-use markup from the source below.`}}},render:()=>t`
  ...
  parameters: {
    docs: {
      description: {
        story: 'Multi-key shortcuts are a single \`<kbd esds-kbd>\` element containing the full combination, e.g. \`⌘+K\`.'
      }
    }
  },
  render: () => html\`
  ...
  parameters: {
    docs: {
      description: {
        story: 'Modifier and special keys are plain Unicode characters typed literally in the markup — the attribute applies no mapping. Copy the glyph you need from the canvas, or the ready-to-use markup from the source below.'
      }
    }
  },
  render: () => html\`
