...
## Demo
`})))()}var T,E,D,O,k,A,j,M;function N(){return(N=e((()=>{S(),r(),a(),w(),x.define(),{args:T,argTypes:E,template:D}=i(`esds-separator`),O={title:`Components/Separator`,component:`esds-separator`,tags:[`autodocs`,`vr-test`],parameters:{docs:{description:{component:C}}},args:T,argTypes:E,render:e=>D(e)},k={},A={args:{orientation:`vertical`},render:e=>n`
    <div style="display: flex; align-items: center; gap: 1rem; height: 3rem">
      <span>Left</span>
      ${D(e)}
      <span>Right</span>
    </div>
  `},j={args:{decorative:!0}},M=[`Default`,`Vertical`,`Decorative`],k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{}`,...k.parameters?.docs?.source}}},A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  args: {
