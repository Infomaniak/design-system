...
| color.background.brand.kchat.default | #009cd4 | #75ddff | var(--esds-color-background-brand-kchat-default) | kChat product brand background colors. |
| color.background.brand.kchat.hover | #007bab | #b6ebff | var(--esds-color-background-brand-kchat-hover) | kChat product brand background colors. |
| color.background.brand.kchat.pressed | #00668d | #2cceff | var(--esds-color-background-brand-kchat-pressed) | kChat product brand background colors. |
...
| color.background.brand.calendar.default | #0a848f | #4cc6d4 | var(--esds-color-background-brand-calendar-default) | Calendar product brand background colors. |
| color.background.brand.calendar.hover | #0f6e77 | #6fe5f4 | var(--esds-color-background-brand-calendar-hover) | Calendar product brand background colors. |
| color.background.brand.calendar.pressed | #0c5961 | #009fad | var(--esds-color-background-brand-calendar-pressed) | Calendar product brand background colors. |
...
| color.background.brand.knote.default | #f94f00 | #ffb36b | var(--esds-color-background-brand-knote-default) | kNote product brand background colors. |
| color.background.brand.knote.hover | #d93a00 | #ffd3a4 | var(--esds-color-background-brand-knote-hover) | kNote product brand background colors. |
| color.background.brand.knote.pressed | #a32c09 | #ff882f | var(--esds-color-background-brand-knote-pressed) | kNote product brand background colors. |
...
| typography.xs.base | 400 0.75rem/16px Infomaniak Sans | 400 0.75rem/16px Infomaniak Sans | var(--esds-typography-xs-base) | N/A |
| typography.xs.emphasized | 500 0.75rem/16px Infomaniak Sans | 500 0.75rem/16px Infomaniak Sans | var(--esds-typography-xs-emphasized) | N/A |
| typography.sm.base | 400 0.875rem/20px Infomaniak Sans | 400 0.875rem/20px Infomaniak Sans | var(--esds-typography-sm-base) | N/A |
| typography.sm.emphasized | 500 0.875rem/20px Infomaniak Sans | 500 0.875rem/20px Infomaniak Sans | var(--esds-typography-sm-emphasized) | N/A |
| typography.md.base | 400 1rem/24px Infomaniak Sans | 400 1rem/24px Infomaniak Sans | var(--esds-typography-md-base) | N/A |
| typography.md.emphasized | 500 1rem/24px Infomaniak Sans | 500 1rem/24px Infomaniak Sans | var(--esds-typography-md-emphasized) | N/A |
| typography.lg.base | 400 1.125rem/26px Infomaniak Sans | 400 1.125rem/26px Infomaniak Sans | var(--esds-typography-lg-base) | N/A |
| typography.lg.emphasized | 500 1.125rem/26px Infomaniak Sans | 500 1.125rem/26px Infomaniak Sans | var(--esds-typography-lg-emphasized) | N/A |
| typography.xl.base | 400 1.25rem/28px Infomaniak Sans | 400 1.25rem/28px Infomaniak Sans | var(--esds-typography-xl-base) | N/A |
| typography.xl.emphasized | 500 1.25rem/28px Infomaniak Sans | 500 1.25rem/28px Infomaniak Sans | var(--esds-typography-xl-emphasized) | N/A |
| typography.2xl.base | 400 1.5rem/32px Infomaniak Sans | 400 1.5rem/32px Infomaniak Sans | var(--esds-typography-2xl-base) | N/A |
| typography.2xl.emphasized | 500 1.5rem/32px Infomaniak Sans | 500 1.5rem/32px Infomaniak Sans | var(--esds-typography-2xl-emphasized) | N/A |
| typography.3xl.base | 400 2rem/40px Infomaniak Sans | 400 2rem/40px Infomaniak Sans | var(--esds-typography-3xl-base) | N/A |
| typography.3xl.emphasized | 500 2rem/40px Infomaniak Sans | 500 2rem/40px Infomaniak Sans | var(--esds-typography-3xl-emphasized) | N/A |
| typography.4xl.base | 400 2.5rem/48px Infomaniak Sans | 400 2.5rem/48px Infomaniak Sans | var(--esds-typography-4xl-base) | N/A |
| typography.4xl.emphasized | 500 2.5rem/48px Infomaniak Sans | 500 2.5rem/48px Infomaniak Sans | var(--esds-typography-4xl-emphasized) | N/A |
| typography.5xl.base | 400 3rem/56px Infomaniak Sans | 400 3rem/56px Infomaniak Sans | var(--esds-typography-5xl-base) | N/A |
| typography.5xl.emphasized | 500 3rem/56px Infomaniak Sans | 500 3rem/56px Infomaniak Sans | var(--esds-typography-5xl-emphasized) | N/A |

## 3. Component Tokens

| Token Name | Light Value | Dark Value | CSS Variable | Description |
|---|---|---|---|---|
| body.xs.font | 400 0.75rem/16px Infomaniak Sans | 400 0.75rem/16px Infomaniak Sans | var(--esds-body-xs-font) | N/A |
| body.sm.font | 400 0.875rem/20px Infomaniak Sans | 400 0.875rem/20px Infomaniak Sans | var(--esds-body-sm-font) | N/A |
| body.md.font | 400 1rem/24px Infomaniak Sans | 400 1rem/24px Infomaniak Sans | var(--esds-body-md-font) | N/A |
| body.lg.font | 400 1.125rem/26px Infomaniak Sans | 400 1.125rem/26px Infomaniak Sans | var(--esds-body-lg-font) | N/A |
| heading.xs.font | 500 1.25rem/28px Infomaniak Sans | 500 1.25rem/28px Infomaniak Sans | var(--esds-heading-xs-font) | N/A |
| heading.sm.font | 500 1.5rem/32px Infomaniak Sans | 500 1.5rem/32px Infomaniak Sans | var(--esds-heading-sm-font) | N/A |
| heading.md.font | 500 2rem/40px Infomaniak Sans | 500 2rem/40px Infomaniak Sans | var(--esds-heading-md-font) | N/A |
| heading.lg.font | 500 2.5rem/48px Infomaniak Sans | 500 2.5rem/48px Infomaniak Sans | var(--esds-heading-lg-font) | N/A |
| heading.xl.font | 500 3rem/56px Infomaniak Sans | 500 3rem/56px Infomaniak Sans | var(--esds-heading-xl-font) | N/A |
