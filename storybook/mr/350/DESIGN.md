...
| kbd.font | 500 0.875rem/20px Suisse Int'l | 500 0.875rem/20px Suisse Int'l | var(--esds-kbd-font) | Default keyboard key typography (medium weight, slightly smaller than body text). |
