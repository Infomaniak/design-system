import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{t as n}from"./react-CnPKFcMr.js";import{F as r,P as i,h as a,m as o,y as s}from"./iframe-DMTyBl0_.js";import{t as c}from"./mdx-react-shim-CDOT2y42.js";import{o as l,s as u,t as d}from"./public-api-B9wz_uXO.js";var f,p=e((()=>{d(),f=new l({resources:[`https://iconify.preprod.dev.infomaniak.ch/`]})})),m,h=e((()=>{m={ABORTED:`ABORTED`,API_ERROR:`API_ERROR`,NETWORK_ERROR:`NETWORK_ERROR`,TIMEOUT:`TIMEOUT`,UNKNOWN_ERROR:`UNKNOWN_ERROR`,BOUNDARY_ERROR:`BOUNDARY_ERROR`}}));function ee(e){return{name:e.name,categories:e.categories}}function g(e){return e instanceof Error?{message:e.message,code:e.name===`AbortError`?m.ABORTED:m.API_ERROR}:{message:`An unknown error occurred`,code:m.UNKNOWN_ERROR}}function _(e=f){let t=(0,v.useRef)(null),n=(0,v.useRef)(null),[r,i]=(0,v.useState)([]),[a,o]=(0,v.useState)(``),[s,c]=(0,v.useState)([]),[l,u]=(0,v.useState)(0),[d,p]=(0,v.useState)(``),[m,h]=(0,v.useState)(``),[_,b]=(0,v.useState)(!1),[x,S]=(0,v.useState)(!1),[te,C]=(0,v.useState)(null),w=_||x,T=(0,v.useCallback)(()=>{t.current!==null&&(t.current.abort(),t.current=null)},[]),E=(0,v.useCallback)(e=>{p(e),n.current!==null&&clearTimeout(n.current),n.current=setTimeout(()=>{h(e.trim().toLowerCase())},y)},[]),D=(0,v.useCallback)(async t=>{try{b(!0),C(null);let n=await e.listIconSets({signal:t}),r=Object.keys(n).sort();i(r),r.length>0&&o(r[0])}catch(e){if(t.aborted)return;C(g(e))}finally{b(!1)}},[e]),O=(0,v.useCallback)(async(t,n)=>{try{u((await e.search({prefix:t,query:``,signal:n})).length)}catch{}},[e]),k=(0,v.useCallback)(async(n,r,i)=>{try{S(!0),C(null),c((await e.search({prefix:n,query:r,signal:i})).map(ee))}catch(e){if(i.aborted)return;C(g(e))}finally{S(!1),t.current?.signal===i&&(t.current=null)}},[e]);(0,v.useEffect)(()=>{let e=new AbortController;return D(e.signal),()=>{e.abort()}},[D]),(0,v.useEffect)(()=>{if(a===``)return;T();let e=new AbortController;return t.current=e,O(a,e.signal),k(a,m,e.signal),()=>{e.abort()}},[a,m,O,k,T]);let A=(0,v.useCallback)(e=>{o(e),p(``),h(``)},[]),j=(0,v.useCallback)(()=>{p(``),h(``),n.current!==null&&(clearTimeout(n.current),n.current=null)},[]),ne=(0,v.useCallback)(()=>{if(r.length===0){T();let e=new AbortController;t.current=e,D(e.signal)}else if(a!==``){T();let e=new AbortController;t.current=e,O(a,e.signal),k(a,m,e.signal)}},[r.length,a,m,D,O,k,T]);return(0,v.useEffect)(()=>()=>{T(),n.current!==null&&clearTimeout(n.current)},[T]),{collections:r,icons:s,totalCount:l,filteredCount:s.length,selectedCollection:a,searchQuery:d,isLoading:w,isLoadingCollections:_,isLoadingIcons:x,error:te,setCollection:A,setSearchQuery:E,retry:ne,clearSearch:j}}var v,y,b=e((()=>{v=t(n(),1),p(),h(),y=300}));function x(){try{return typeof window>`u`||!window.parent?null:new URL(window.parent.location.href)}catch{return null}}function S(e){let t=x();return t?t.searchParams.get(e):null}function te(e){let t=x();if(!t)return;Object.entries(e).forEach(([e,n])=>{n===null||n===``?t.searchParams.delete(e):t.searchParams.set(e,n)});let n=t.search,r=t.toString().split(`?`)[0]+n.replace(/%2F/g,`/`);window.parent.history.replaceState(null,``,r)}function C(){let e=_(f),{collections:t,selectedCollection:n,searchQuery:r,setCollection:i,setSearchQuery:a}=e,[o,s]=(0,w.useState)(!1),c=(0,w.useRef)(null),l=(0,w.useRef)({search:``,collection:``});(0,w.useEffect)(()=>{if(o||t.length===0)return;let e=S(E),n=S(T);e&&t.includes(e)&&i(e),n&&a(n),s(!0)},[t,o,i,a]);let u=(0,w.useCallback)((e,t)=>{l.current.search===e&&l.current.collection===t||(l.current={search:e,collection:t},te({[T]:e||null,[E]:t||null}))},[]);return(0,w.useEffect)(()=>{if(o)return c.current&&clearTimeout(c.current),c.current=setTimeout(()=>{u(r,n)},D),()=>{c.current&&clearTimeout(c.current)}},[r,n,o,u]),(0,w.useEffect)(()=>()=>{c.current&&clearTimeout(c.current)},[]),e}var w,T,E,D,O=e((()=>{w=t(n(),1),p(),b(),T=`search`,E=`collection`,D=100})),k,A,j,ne=e((()=>{k=t(n(),1),A=i(),j=({collections:e,selected:t,onChange:n,disabled:r=!1})=>{let i=e=>{n(e.target.value)},a=k.useMemo(()=>[...e].sort((e,t)=>e.localeCompare(t)),[e]);return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`style`,{children:`
      ...
      `}),(0,F.jsx)(`div`,{className:`icon-gallery-skeleton`,children:Array.from({length:e}).map((e,t)=>(0,F.jsxs)(`div`,{className:`icon-gallery-skeleton__item`,children:[(0,F.jsx)(`div`,{className:`icon-gallery-skeleton__icon`}),(0,F.jsx)(`div`,{className:`icon-gallery-skeleton__text`})]},t))})]})})),se,L,ce,le=e((()=>{se=t(n(),1),L=i(),ce=({icon:e,prefix:t,iconSize:n=48,onClick:r})=>{let i=`${t}:${e.name}`,a=(0,se.useCallback)(()=>{r?.(e)},[r,e]);return(0,L.jsxs)(L.Fragment,{children:[(0,L.jsx)(`style`,{children:`
        .icon-card {
          display: flex;
          flex-direction: column;
          align-items: center;
      ...
      `}),(0,V.jsxs)(`div`,{className:`metadata-section`,children:[(0,V.jsx)(`div`,{className:`metadata-label`,children:`Tags:`}),(0,V.jsx)(`div`,{className:`metadata-value`,children:t.length>0?t:`No tags`})]}),(0,V.jsxs)(`div`,{className:`metadata-section`,children:[(0,V.jsx)(`div`,{className:`metadata-label`,children:`Collection:`}),(0,V.jsx)(`div`,{className:`metadata-value`,children:e.collection})]}),(0,V.jsxs)(`div`,{className:`metadata-section`,children:[(0,V.jsx)(`div`,{className:`metadata-label`,children:`License:`}),(0,V.jsx)(`div`,{className:`metadata-value`,children:e.license})]})]})}}));function pe({icon:e,isOpen:t,prefix:n,onClose:r}){let[i,a]=(0,U.useState)(null);if((0,U.useEffect)(()=>{t&&e?f.listIconsCached({prefix:n,info:!0}).then(t=>{let r=u(t).find(t=>t.name===e.name);a(r?{name:r.name,iconId:`${n}:${r.name}`,tags:Array.from(r.categories||new Set),collection:t.info?.name??n,license:t.info?.license?.title??`Unknown License`}:null)}).catch(()=>{a(null)}):a(null)},[t,e,n]),(0,U.useEffect)(()=>(t?document.body.style.overflow=`hidden`:document.body.style.overflow=``,()=>{document.body.style.overflow=``}),[t]),(0,U.useEffect)(()=>{let e=e=>{e.key===`Escape`&&r()};return t&&document.addEventListener(`keydown`,e),()=>{document.removeEventListener(`keydown`,e)}},[t,r]),!t||!e)return null;let o=()=>{r()},s=e=>{e.stopPropagation()},c=`${n}:${e.name}`,l=`<esds-icon name="${c}" />`,d=document.getElementById(`modal-root`)||document.body;return(0,me.createPortal)((0,W.jsx)(`div`,{"data-testid":`modal-backdrop`,onClick:o,style:{position:`fixed`,top:0,left:0,right:0,bottom:0,backgroundColor:`rgba(0, 0, 0, 0.5)`,display:`flex`,justifyContent:`center`,alignItems:`center`,zIndex:1e3},children:(0,W.jsxs)(`div`,{onClick:s,role:`dialog`,"aria-modal":`true`,"aria-label":`Icon details`,style:{fontFamily:`inherit`,backgroundColor:`white`,borderRadius:`8px`,padding:`24px`,maxWidth:`600px`,width:`90%`,maxHeight:`90vh`,overflow:`auto`,position:`relative`},children:[(0,W.jsx)(`button`,{onClick:r,"aria-label":`Close dialog`,style:{position:`absolute`,top:`10px`,right:`10px`,background:`none`,border:`none`,cursor:`pointer`,fontSize:`24px`},children:`×`}),(0,W.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`,marginBottom:`var(--esds-spacing-2xl)`},children:(0,W.jsx)(`esds-icon`,{style:{fontSize:`var(--esds-icon-size-4xl)`},name:c})}),(0,W.jsx)(`div`,{style:{marginBottom:`var(--esds-spacing-2xl)`},children:(0,W.jsx)(B,{value:c,label:``,size:`lg`})}),(0,W.jsx)(`div`,{style:{marginBottom:`var(--esds-spacing-2xl)`},children:(0,W.jsx)(B,{value:l,label:`Component`})}),i&&(0,W.jsx)(H,{metadata:i})]})}),d)}var U,me,W,he=e((()=>{d(),U=t(n(),1),me=t(r(),1),p(),de(),fe(),W=i()})),G,K,ge,_e=e((()=>{G=t(n(),1),le(),he(),K=i(),ge=({icons:e,prefix:t,iconSize:n})=>{let[r,i]=(0,G.useState)(null),[a,o]=(0,G.useState)(!1),s=(0,G.useCallback)(e=>{i(e),o(!0)},[]),c=(0,G.useCallback)(()=>{o(!1)},[]);return e.length===0?null:(0,K.jsxs)(K.Fragment,{children:[(0,K.jsx)(`style`,{children:`
        .icon-grid {
          display: grid;
          grid-template-columns: repeat(2, 1fr);
          gap: 16px;
      ...
      `}),(0,J.jsxs)(`div`,{className:`icon-size-slider`,children:[(0,J.jsx)(`span`,{className:`icon-size-slider__label`,children:`Size`}),(0,J.jsx)(`input`,{type:`range`,min:n,max:r,step:i,value:e,onChange:e=>{t(Number(e.target.value))},className:`icon-size-slider__input`,"aria-label":`Icon size`,disabled:a}),(0,J.jsxs)(`span`,{className:`icon-size-slider__value`,children:[e,`px`]})]})]})})),Y,X,Te,Ee,De=e((()=>{Y=t(n(),1),O(),ne(),ie(),ae(),oe(),_e(),ye(),we(),X=i(),Te=48,Ee=()=>{let{collections:e,icons:t,totalCount:n,filteredCount:r,selectedCollection:i,searchQuery:a,isLoading:o,isLoadingCollections:s,error:c,setCollection:l,setSearchQuery:u,retry:d,clearSearch:f}=C(),[p,m]=(0,Y.useState)(Te),h=e=>{l(e)},ee=e=>{u(e)},g=()=>{f()},_=()=>{d()},v=e=>{m(e)},y=()=>s?(0,X.jsxs)(`div`,{className:`icon-gallery__loading`,children:[(0,X.jsx)(I,{}),(0,X.jsx)(`p`,{className:`icon-gallery__loading-text`,children:`Loading collections...`})]}):o?(0,X.jsx)(I,{}):c===null?t.length===0?(0,X.jsx)(re,{searchQuery:a,onClearSearch:a.length>0?g:void 0}):(0,X.jsx)(ge,{icons:t,prefix:i,iconSize:p}):(0,X.jsx)(P,{error:c,onRetry:_}),b=o||c!==null;return(0,X.jsxs)(X.Fragment,{children:[(0,X.jsx)(`style`,{children:`
        .icon-gallery {
          padding: 1.5rem;
        }
      ...
      `}),(0,X.jsxs)(`div`,{className:`icon-gallery`,children:[(0,X.jsxs)(`div`,{className:`icon-gallery__header`,children:[(0,X.jsxs)(`div`,{className:`icon-gallery__title-row`,children:[(0,X.jsx)(`h1`,{className:`icon-gallery__title`,children:`Icon Gallery`}),(0,X.jsxs)(`span`,{className:`icon-gallery__count`,children:[`Showing `,r,` of `,n,` icons`]})]}),(0,X.jsx)(`div`,{className:`icon-gallery__controls-wrapper`,children:(0,X.jsxs)(`div`,{className:`icon-gallery__controls`,children:[(0,X.jsx)(`div`,{className:`icon-gallery__search`,children:(0,X.jsx)(ve,{value:a,onChange:ee,disabled:b,onClear:g})}),(0,X.jsx)(`div`,{className:`icon-gallery__filter`,children:(0,X.jsx)(j,{collections:e,selected:i,onChange:h,disabled:b})}),(0,X.jsx)(`div`,{className:`icon-gallery__slider`,children:(0,X.jsx)(Ce,{value:p,onChange:v,disabled:b})})]})})]}),(0,X.jsx)(`div`,{children:y()})]})]})}})),Oe,Z,Q,ke,Ae=e((()=>{Oe=t(n(),1),Z=i(),Q={message:`An unexpected error occurred in the icon gallery`,code:`BOUNDARY_ERROR`},ke=class extends Oe.Component{state={hasError:!1,error:null};static getDerivedStateFromError(e){return{hasError:!0,error:{message:e.message||Q.message,code:e.name===`AbortError`?`ABORTED`:Q.code}}}componentDidCatch(e,t){console.error(`IconGalleryErrorBoundary caught an error:`,e,t)}render(){return this.state.hasError?this.props.fallback?this.props.fallback:(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsx)(`style`,{children:`
