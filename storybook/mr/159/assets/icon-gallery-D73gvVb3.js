import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{B as n,D as r,F as i,O as a,R as o,c as s,f as c,s as l,z as u}from"./iframe-CqF0JJOL.js";import{t as d}from"./mdx-react-shim-P_3FYBbY.js";var f,p=e((()=>{o(),f=new u({resources:[`https://iconify.preprod.dev.infomaniak.ch/`]})})),m,h=e((()=>{m={ABORTED:`ABORTED`,API_ERROR:`API_ERROR`,NETWORK_ERROR:`NETWORK_ERROR`,TIMEOUT:`TIMEOUT`,UNKNOWN_ERROR:`UNKNOWN_ERROR`,BOUNDARY_ERROR:`BOUNDARY_ERROR`}}));function ee(e){return{name:e.name,categories:e.categories}}function g(e){return e instanceof Error?{message:e.message,code:e.name===`AbortError`?m.ABORTED:m.API_ERROR}:{message:`An unknown error occurred`,code:m.UNKNOWN_ERROR}}function _(e=f){let t=(0,v.useRef)(null),n=(0,v.useRef)(null),[r,i]=(0,v.useState)([]),[a,o]=(0,v.useState)(``),[s,c]=(0,v.useState)([]),[l,u]=(0,v.useState)(0),[d,p]=(0,v.useState)(``),[m,h]=(0,v.useState)(``),[_,b]=(0,v.useState)(!1),[x,S]=(0,v.useState)(!1),[te,C]=(0,v.useState)(null),w=_||x,T=(0,v.useCallback)(()=>{t.current!==null&&(t.current.abort(),t.current=null)},[]),E=(0,v.useCallback)(e=>{p(e),n.current!==null&&clearTimeout(n.current),n.current=setTimeout(()=>{h(e.trim().toLowerCase())},y)},[]),D=(0,v.useCallback)(async t=>{try{b(!0),C(null);let n=await e.listIconSets({signal:t}),r=Object.keys(n).sort();i(r),r.length>0&&o(r[0])}catch(e){if(t.aborted)return;C(g(e))}finally{b(!1)}},[e]),O=(0,v.useCallback)(async(t,n)=>{try{u((await e.search({prefix:t,query:``,signal:n})).length)}catch{}},[e]),k=(0,v.useCallback)(async(n,r,i)=>{try{S(!0),C(null),c((await e.search({prefix:n,query:r,signal:i})).map(ee))}catch(e){if(i.aborted)return;C(g(e))}finally{S(!1),t.current?.signal===i&&(t.current=null)}},[e]);(0,v.useEffect)(()=>{let e=new AbortController;return D(e.signal),()=>{e.abort()}},[D]),(0,v.useEffect)(()=>{if(a===``)return;T();let e=new AbortController;return t.current=e,O(a,e.signal),k(a,m,e.signal),()=>{e.abort()}},[a,m,O,k,T]);let A=(0,v.useCallback)(e=>{o(e),p(``),h(``)},[]),j=(0,v.useCallback)(()=>{p(``),h(``),n.current!==null&&(clearTimeout(n.current),n.current=null)},[]),ne=(0,v.useCallback)(()=>{if(r.length===0){T();let e=new AbortController;t.current=e,D(e.signal)}else if(a!==``){T();let e=new AbortController;t.current=e,O(a,e.signal),k(a,m,e.signal)}},[r.length,a,m,D,O,k,T]);return(0,v.useEffect)(()=>()=>{T(),n.current!==null&&clearTimeout(n.current)},[T]),{collections:r,icons:s,totalCount:l,filteredCount:s.length,selectedCollection:a,searchQuery:d,isLoading:w,isLoadingCollections:_,isLoadingIcons:x,error:te,setCollection:A,setSearchQuery:E,retry:ne,clearSearch:j}}var v,y,b=e((()=>{o(),v=t(i(),1),p(),h(),y=300}));function x(){try{return typeof window>`u`||!window.parent?null:new URL(window.parent.location.href)}catch{return null}}function S(e){let t=x();return t?t.searchParams.get(e):null}function te(e){let t=x();if(!t)return;Object.entries(e).forEach(([e,n])=>{n===null||n===``?t.searchParams.delete(e):t.searchParams.set(e,n)});let n=t.search,r=t.toString().split(`?`)[0]+n.replace(/%2F/g,`/`);window.parent.history.replaceState(null,``,r)}function C(){let e=_(f),{collections:t,selectedCollection:n,searchQuery:r,setCollection:i,setSearchQuery:a}=e,[o,s]=(0,w.useState)(!1),c=(0,w.useRef)(null),l=(0,w.useRef)({search:``,collection:``});(0,w.useEffect)(()=>{if(o||t.length===0)return;let e=S(E),n=S(T);e&&t.includes(e)&&i(e),n&&a(n),s(!0)},[t,o,i,a]);let u=(0,w.useCallback)((e,t)=>{l.current.search===e&&l.current.collection===t||(l.current={search:e,collection:t},te({[T]:e||null,[E]:t||null}))},[]);return(0,w.useEffect)(()=>{if(o)return c.current&&clearTimeout(c.current),c.current=setTimeout(()=>{u(r,n)},D),()=>{c.current&&clearTimeout(c.current)}},[r,n,o,u]),(0,w.useEffect)(()=>()=>{c.current&&clearTimeout(c.current)},[]),e}var w,T,E,D,O=e((()=>{w=t(i(),1),p(),b(),T=`search`,E=`collection`,D=100})),k,A,j,ne=e((()=>{k=t(i(),1),A=r(),j=({collections:e,selected:t,onChange:n,disabled:r=!1})=>{let i=e=>{n(e.target.value)},a=k.useMemo(()=>[...e].sort((e,t)=>e.localeCompare(t)),[e]);return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`style`,{children:`
      ...
      `}),(0,V.jsxs)(`div`,{className:`metadata-section`,children:[(0,V.jsx)(`div`,{className:`metadata-label`,children:`Tags:`}),(0,V.jsx)(`div`,{className:`metadata-value`,children:t.length>0?t:`No tags`})]}),(0,V.jsxs)(`div`,{className:`metadata-section`,children:[(0,V.jsx)(`div`,{className:`metadata-label`,children:`Collection:`}),(0,V.jsx)(`div`,{className:`metadata-value`,children:e.collection})]}),(0,V.jsxs)(`div`,{className:`metadata-section`,children:[(0,V.jsx)(`div`,{className:`metadata-label`,children:`License:`}),(0,V.jsx)(`div`,{className:`metadata-value`,children:e.license})]})]})}}));function pe({icon:e,isOpen:t,prefix:r,onClose:i}){let[a,o]=(0,U.useState)(null);if((0,U.useEffect)(()=>{t&&e?f.listIconsCached({prefix:r,info:!0}).then(t=>{let i=n(t).find(t=>t.name===e.name);o(i?{name:i.name,iconId:`${r}:${i.name}`,tags:Array.from(i.categories||new Set),collection:t.info?.name??r,license:t.info?.license?.title??`Unknown License`}:null)}).catch(()=>{o(null)}):o(null)},[t,e,r]),(0,U.useEffect)(()=>(t?document.body.style.overflow=`hidden`:document.body.style.overflow=``,()=>{document.body.style.overflow=``}),[t]),(0,U.useEffect)(()=>{let e=e=>{e.key===`Escape`&&i()};return t&&document.addEventListener(`keydown`,e),()=>{document.removeEventListener(`keydown`,e)}},[t,i]),!t||!e)return null;let s=()=>{i()},c=e=>{e.stopPropagation()},l=`${r}:${e.name}`,u=`<esds-icon name="${l}" />`,d=document.getElementById(`modal-root`)||document.body;return(0,me.createPortal)((0,W.jsx)(`div`,{"data-testid":`modal-backdrop`,onClick:s,style:{position:`fixed`,top:0,left:0,right:0,bottom:0,backgroundColor:`rgba(0, 0, 0, 0.5)`,display:`flex`,justifyContent:`center`,alignItems:`center`,zIndex:1e3},children:(0,W.jsxs)(`div`,{onClick:c,role:`dialog`,"aria-modal":`true`,"aria-label":`Icon details`,style:{fontFamily:`inherit`,backgroundColor:`white`,borderRadius:`8px`,padding:`24px`,maxWidth:`600px`,width:`90%`,maxHeight:`90vh`,overflow:`auto`,position:`relative`},children:[(0,W.jsx)(`button`,{onClick:i,"aria-label":`Close dialog`,style:{position:`absolute`,top:`10px`,right:`10px`,background:`none`,border:`none`,cursor:`pointer`,fontSize:`24px`},children:`×`}),(0,W.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`,marginBottom:`var(--esds-spacing-2xl)`},children:(0,W.jsx)(`esds-icon`,{style:{fontSize:`var(--esds-icon-size-4xl)`},name:l})}),(0,W.jsx)(`div`,{style:{marginBottom:`var(--esds-spacing-2xl)`},children:(0,W.jsx)(B,{value:l,label:``,size:`lg`})}),(0,W.jsx)(`div`,{style:{marginBottom:`var(--esds-spacing-2xl)`},children:(0,W.jsx)(B,{value:u,label:`Component`})}),a&&(0,W.jsx)(H,{metadata:a})]})}),d)}var U,me,W,he=e((()=>{o(),U=t(i(),1),me=t(a(),1),p(),de(),fe(),W=r()})),G,K,ge,_e=e((()=>{G=t(i(),1),le(),he(),K=r(),ge=({icons:e,prefix:t,iconSize:n})=>{let[r,i]=(0,G.useState)(null),[a,o]=(0,G.useState)(!1),s=(0,G.useCallback)(e=>{i(e),o(!0)},[]),c=(0,G.useCallback)(()=>{o(!1)},[]);return e.length===0?null:(0,K.jsxs)(K.Fragment,{children:[(0,K.jsx)(`style`,{children:`
        .icon-grid {
          display: grid;
          grid-template-columns: repeat(2, 1fr);
          gap: 16px;
