import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{t as n}from"./react-CnPKFcMr.js";import{L as r,R as i,S as a,_ as o,n as s,r as c,s as l,t as u,v as d}from"./iframe-DtSlCbZq.js";import{t as f}from"./mdx-react-shim-COLfO_l8.js";var p,m=e((()=>{p={ABORTED:`ABORTED`,API_ERROR:`API_ERROR`,NETWORK_ERROR:`NETWORK_ERROR`,TIMEOUT:`TIMEOUT`,UNKNOWN_ERROR:`UNKNOWN_ERROR`,BOUNDARY_ERROR:`BOUNDARY_ERROR`}}));function h(e){return{name:e.name,categories:e.categories}}function g(e){return e instanceof Error?{message:e.message,code:e.name===`AbortError`?p.ABORTED:p.API_ERROR}:{message:`An unknown error occurred`,code:p.UNKNOWN_ERROR}}function _(e=u){let t=(0,v.useRef)(null),n=(0,v.useRef)(null),[r,i]=(0,v.useState)([]),[a,o]=(0,v.useState)(``),[s,c]=(0,v.useState)([]),[l,d]=(0,v.useState)(0),[f,p]=(0,v.useState)(``),[m,_]=(0,v.useState)(``),[b,x]=(0,v.useState)(!1),[S,C]=(0,v.useState)(!1),[ee,w]=(0,v.useState)(null),T=b||S,E=(0,v.useCallback)(()=>{t.current!==null&&(t.current.abort(),t.current=null)},[]),D=(0,v.useCallback)(e=>{p(e),n.current!==null&&clearTimeout(n.current),n.current=setTimeout(()=>{_(e.trim().toLowerCase())},y)},[]),O=(0,v.useCallback)(async t=>{try{x(!0),w(null);let n=await e.listIconSets({signal:t}),r=Object.keys(n).sort();i(r),r.length>0&&o(r[0])}catch(e){if(t.aborted)return;w(g(e))}finally{x(!1)}},[e]),k=(0,v.useCallback)(async(t,n)=>{try{d((await e.search({prefix:t,query:``,signal:n})).length)}catch{}},[e]),A=(0,v.useCallback)(async(n,r,i)=>{try{C(!0),w(null),c((await e.search({prefix:n,query:r,signal:i})).map(h))}catch(e){if(i.aborted)return;w(g(e))}finally{C(!1),t.current?.signal===i&&(t.current=null)}},[e]);(0,v.useEffect)(()=>{let e=new AbortController;return O(e.signal),()=>{e.abort()}},[O]),(0,v.useEffect)(()=>{if(a===``)return;E();let e=new AbortController;return t.current=e,k(a,e.signal),A(a,m,e.signal),()=>{e.abort()}},[a,m,k,A,E]);let j=(0,v.useCallback)(e=>{o(e),p(``),_(``)},[]),te=(0,v.useCallback)(()=>{p(``),_(``),n.current!==null&&(clearTimeout(n.current),n.current=null)},[]),M=(0,v.useCallback)(()=>{if(r.length===0){E();let e=new AbortController;t.current=e,O(e.signal)}else if(a!==``){E();let e=new AbortController;t.current=e,k(a,e.signal),A(a,m,e.signal)}},[r.length,a,m,O,k,A,E]);return(0,v.useEffect)(()=>()=>{E(),n.current!==null&&clearTimeout(n.current)},[E]),{collections:r,icons:s,totalCount:l,filteredCount:s.length,selectedCollection:a,searchQuery:f,isLoading:T,isLoadingCollections:b,isLoadingIcons:S,error:ee,setCollection:j,setSearchQuery:D,retry:M,clearSearch:te}}var v,y,b=e((()=>{v=t(n(),1),s(),m(),y=300}));function x(){try{return typeof window>`u`||!window.parent?null:new URL(window.parent.location.href)}catch{return null}}function S(e){let t=x();return t?t.searchParams.get(e):null}function C(e){let t=x();if(!t)return;Object.entries(e).forEach(([e,n])=>{n===null||n===``?t.searchParams.delete(e):t.searchParams.set(e,n)});let n=t.search,r=t.toString().split(`?`)[0]+n.replace(/%2F/g,`/`);window.parent.history.replaceState(null,``,r)}function ee(){let e=_(u),{collections:t,selectedCollection:n,searchQuery:r,setCollection:i,setSearchQuery:a}=e,[o,s]=(0,w.useState)(!1),c=(0,w.useRef)(null),l=(0,w.useRef)({search:``,collection:``});(0,w.useEffect)(()=>{if(o||t.length===0)return;let e=S(E),n=S(T);e&&t.includes(e)&&i(e),n&&a(n),s(!0)},[t,o,i,a]);let d=(0,w.useCallback)((e,t)=>{l.current.search===e&&l.current.collection===t||(l.current={search:e,collection:t},C({[T]:e||null,[E]:t||null}))},[]);return(0,w.useEffect)(()=>{if(o)return c.current&&clearTimeout(c.current),c.current=setTimeout(()=>{d(r,n)},D),()=>{c.current&&clearTimeout(c.current)}},[r,n,o,d]),(0,w.useEffect)(()=>()=>{c.current&&clearTimeout(c.current)},[]),e}var w,T,E,D,O=e((()=>{w=t(n(),1),s(),b(),T=`search`,E=`collection`,D=100})),k,A,j,te=e((()=>{k=t(n(),1),A=r(),j=({collections:e,selected:t,onChange:n,disabled:r=!1})=>{let i=e=>{n(e.target.value)},a=k.useMemo(()=>[...e].sort((e,t)=>e.localeCompare(t)),[e]);return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`style`,{children:`
      ...
      `}),(0,P.jsx)(`div`,{className:`icon-gallery-skeleton`,children:Array.from({length:e}).map((e,t)=>(0,P.jsxs)(`div`,{className:`icon-gallery-skeleton__item`,children:[(0,P.jsx)(`div`,{className:`icon-gallery-skeleton__icon`}),(0,P.jsx)(`div`,{className:`icon-gallery-skeleton__text`})]},t))})]})})),se,I,ce,le=e((()=>{se=t(n(),1),I=r(),ce=({icon:e,prefix:t,iconSize:n=48,onClick:r})=>{let i=`${t}:${e.name}`,a=(0,se.useCallback)(()=>{r?.(e)},[r,e]);return(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(`style`,{children:`
        .icon-card {
          display: flex;
          flex-direction: column;
          align-items: center;
      ...
      `}),(0,B.jsxs)(`div`,{className:`metadata-section`,children:[(0,B.jsx)(`div`,{className:`metadata-label`,children:`Tags:`}),(0,B.jsx)(`div`,{className:`metadata-value`,children:t.length>0?t:`No tags`})]}),(0,B.jsxs)(`div`,{className:`metadata-section`,children:[(0,B.jsx)(`div`,{className:`metadata-label`,children:`Collection:`}),(0,B.jsx)(`div`,{className:`metadata-value`,children:e.collection})]}),(0,B.jsxs)(`div`,{className:`metadata-section`,children:[(0,B.jsx)(`div`,{className:`metadata-label`,children:`License:`}),(0,B.jsx)(`div`,{className:`metadata-value`,children:e.license})]})]})}}));function pe({icon:e,isOpen:t,prefix:n,onClose:r}){let[i,a]=(0,H.useState)(null);if((0,H.useEffect)(()=>{t&&e?u.listIconsCached({prefix:n,info:!0}).then(t=>{let r=l(t).find(t=>t.name===e.name);a(r?{name:r.name,iconId:`${n}:${r.name}`,tags:Array.from(r.categories||new Set),collection:t.info?.name??n,license:t.info?.license?.title??`Unknown License`}:null)}).catch(()=>{a(null)}):a(null)},[t,e,n]),(0,H.useEffect)(()=>(t?document.body.style.overflow=`hidden`:document.body.style.overflow=``,()=>{document.body.style.overflow=``}),[t]),(0,H.useEffect)(()=>{let e=e=>{e.key===`Escape`&&r()};return t&&document.addEventListener(`keydown`,e),()=>{document.removeEventListener(`keydown`,e)}},[t,r]),!t||!e)return null;let o=()=>{r()},s=e=>{e.stopPropagation()},c=`${n}:${e.name}`,d=`<esds-icon name="${c}" />`,f=document.getElementById(`modal-root`)||document.body;return(0,U.createPortal)((0,W.jsx)(`div`,{"data-testid":`modal-backdrop`,onClick:o,style:{position:`fixed`,top:0,left:0,right:0,bottom:0,backgroundColor:`rgba(0, 0, 0, 0.5)`,display:`flex`,justifyContent:`center`,alignItems:`center`,zIndex:1e3},children:(0,W.jsxs)(`div`,{onClick:s,role:`dialog`,"aria-modal":`true`,"aria-label":`Icon details`,style:{fontFamily:`inherit`,backgroundColor:`white`,borderRadius:`8px`,padding:`24px`,maxWidth:`600px`,width:`90%`,maxHeight:`90vh`,overflow:`auto`,position:`relative`},children:[(0,W.jsx)(`button`,{onClick:r,"aria-label":`Close dialog`,style:{position:`absolute`,top:`10px`,right:`10px`,background:`none`,border:`none`,cursor:`pointer`,fontSize:`24px`},children:`×`}),(0,W.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`,marginBottom:`var(--esds-spacing-2xl)`},children:(0,W.jsx)(`esds-icon`,{style:{fontSize:`var(--esds-icon-size-xl)`},name:c})}),(0,W.jsx)(`div`,{style:{marginBottom:`var(--esds-spacing-2xl)`},children:(0,W.jsx)(z,{value:c,label:``,size:`lg`})}),(0,W.jsx)(`div`,{style:{marginBottom:`var(--esds-spacing-2xl)`},children:(0,W.jsx)(z,{value:d,label:`Component`})}),i&&(0,W.jsx)(V,{metadata:i})]})}),f)}var H,U,W,me=e((()=>{c(),H=t(n(),1),U=t(i(),1),s(),de(),fe(),W=r()})),G,K,he,ge=e((()=>{G=t(n(),1),le(),me(),K=r(),he=({icons:e,prefix:t,iconSize:n})=>{let[r,i]=(0,G.useState)(null),[a,o]=(0,G.useState)(!1),s=(0,G.useCallback)(e=>{i(e),o(!0)},[]),c=(0,G.useCallback)(()=>{o(!1)},[]);return e.length===0?null:(0,K.jsxs)(K.Fragment,{children:[(0,K.jsx)(`style`,{children:`
        .icon-grid {
          display: grid;
          grid-template-columns: repeat(2, 1fr);
          gap: 16px;
      ...
      `}),(0,J.jsxs)(`div`,{className:`icon-size-slider`,children:[(0,J.jsx)(`span`,{className:`icon-size-slider__label`,children:`Size`}),(0,J.jsx)(`input`,{type:`range`,min:n,max:r,step:i,value:e,onChange:e=>{t(Number(e.target.value))},className:`icon-size-slider__input`,"aria-label":`Icon size`,disabled:a}),(0,J.jsxs)(`span`,{className:`icon-size-slider__value`,children:[e,`px`]})]})]})})),Y,X,we,Te,Ee=e((()=>{Y=t(n(),1),O(),te(),re(),ae(),oe(),ge(),ve(),Ce(),X=r(),we=48,Te=()=>{let{collections:e,icons:t,totalCount:n,filteredCount:r,selectedCollection:i,searchQuery:a,isLoading:o,isLoadingCollections:s,error:c,setCollection:l,setSearchQuery:u,retry:d,clearSearch:f}=ee(),[p,m]=(0,Y.useState)(we),h=e=>{l(e)},g=e=>{u(e)},_=()=>{f()},v=()=>{d()},y=e=>{m(e)},b=()=>s?(0,X.jsxs)(`div`,{className:`icon-gallery__loading`,children:[(0,X.jsx)(F,{}),(0,X.jsx)(`p`,{className:`icon-gallery__loading-text`,children:`Loading collections...`})]}):o?(0,X.jsx)(F,{}):c===null?t.length===0?(0,X.jsx)(ne,{searchQuery:a,onClearSearch:a.length>0?_:void 0}):(0,X.jsx)(he,{icons:t,prefix:i,iconSize:p}):(0,X.jsx)(ie,{error:c,onRetry:v}),x=o||c!==null;return(0,X.jsxs)(X.Fragment,{children:[(0,X.jsx)(`style`,{children:`
        .icon-gallery {
          padding: 1.5rem;
        }
...
`,(0,$.jsx)(Oe,{children:(0,$.jsx)(Te,{})})]})}function je(e={}){let{wrapper:t}={...a(),...e.components};return t?(0,$.jsx)(t,{...e,children:(0,$.jsx)(Ae,{...e})}):Ae(e)}var $;e((()=>{$=r(),f(),d(),Ee(),ke()}))();export{je as default};