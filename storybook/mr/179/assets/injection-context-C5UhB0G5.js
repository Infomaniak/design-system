import{i as e}from"./preload-helper-xPQekRTU.js";import{P as t,h as n,m as r,y as i}from"./iframe-DOx3eipX.js";import{t as a}from"./mdx-react-shim-DrF6v9tB.js";function o(e){let t={blockquote:`blockquote`,code:`code`,em:`em`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,h5:`h5`,hr:`hr`,p:`p`,pre:`pre`,strong:`strong`,...i(),...e.components};return(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(r,{title:`Components/Helpers/InjectionContext`}),`
...
`,(0,c.jsx)(t.pre,{children:(0,c.jsx)(t.code,{className:`language-ts`,children:`// exemple: setup the IconifyApi to point on the preprod environment
...
`,(0,c.jsxs)(t.p,{children:[`An `,(0,c.jsx)(t.code,{children:`InjectionContext`}),` can be applied to any DOM element:`]}),`
`,(0,c.jsx)(t.p,{children:`The element itself, as well as every child (direct or indirect) of it, will inherit of this context.`}),`
`,(0,c.jsxs)(t.p,{children:[`Multiple `,(0,c.jsx)(t.code,{children:`InjectionContext`}),` can be applied to different nodes in the DOM tree:
a `,(0,c.jsx)(t.em,{children:`key`}),` (`,(0,c.jsx)(t.code,{children:`InjectionContext.get(node, key)`}),`) is resolved exploring the stating `,(0,c.jsx)(t.em,{children:`node`}),` itself, and each parent of it (or `,(0,c.jsx)(t.code,{children:`InjectionContext.root`}),` when `,(0,c.jsx)(t.code,{children:`document`}),` is reached),
