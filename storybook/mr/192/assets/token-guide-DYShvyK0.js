import{i as e}from"./preload-helper-xPQekRTU.js";import{D as t,c as n,f as r,s as i}from"./iframe-D1oxIuea.js";import{t as a}from"./mdx-react-shim-BPJrnveq.js";function o(e){let t={a:`a`,br:`br`,code:`code`,div:`div`,em:`em`,h2:`h2`,h3:`h3`,h4:`h4`,h5:`h5`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...r(),...e.components},{Table:n}=t;return n||c(`Table`,!0),(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(i,{title:`Design Tokens/Getting Started`}),`
...
`})})]})}function s(e={}){let{wrapper:t}={...r(),...e.components};return t?(0,l.jsx)(t,{...e,children:(0,l.jsx)(o,{...e})}):o(e)}function c(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}var l;e((()=>{l=t(),a(),n()}))();export{s as default};