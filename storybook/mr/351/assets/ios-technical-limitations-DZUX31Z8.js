import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{o as t,s as n}from"./blocks-BMm7LR9E.js";import{a as r}from"./chunk-W22LQPXL-CTfnVyQS.js";import{i,r as a}from"./react-Bl2r1tuC.js";function o(e){let n={blockquote:`blockquote`,h1:`h1`,h2:`h2`,h3:`h3`,hr:`hr`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...i(),...e.components},{Table:r}=n;return r||c(`Table`,!0),(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(t,{title:`Designers Guide/iOS/iOS - Technical Limitations`}),`
...
`,(0,l.jsxs)(n.li,{children:[(0,l.jsx)(n.strong,{children:`Widgets`}),` can be fully customized except for sizes (3 default sizes: see the kit)`]}),`
`,(0,l.jsxs)(n.li,{children:[`Display latency can go up to `,(0,l.jsx)(n.strong,{children:`15 min`})]}),`
`]}),`
...
`,(0,l.jsxs)(n.ul,{children:[`
`,(0,l.jsx)(n.li,{children:`Fully customizable (size, color…)`}),`
`]}),`
`,(0,l.jsx)(n.h2,{id:`sheets`,children:`Sheets`}),`
`,(0,l.jsxs)(n.ul,{children:[`
`,(0,l.jsxs)(n.li,{children:[(0,l.jsx)(n.strong,{children:`Grabber`}),` present or not depending on needs, if the sheet can be dismissed via swipe.`]}),`
`,(0,l.jsxs)(n.li,{children:[`3 heights enforced by Apple: `,(0,l.jsx)(n.strong,{children:`small`}),`, `,(0,l.jsx)(n.strong,{children:`medium`}),`, `,(0,l.jsx)(n.strong,{children:`large`}),`, or adapt the sheet size to its content.`]}),`
...
`,(0,l.jsxs)(n.li,{children:[(0,l.jsx)(n.strong,{children:`Close button strongly recommended`}),` for accessibility; Apple provides a "cancellation zone" that adapts to the region (e.g. Arabic-speaking countries → left).`]}),`
`]}),`
...
`,(0,l.jsxs)(n.ul,{children:[`
`,(0,l.jsxs)(n.li,{children:[`The `,(0,l.jsx)(n.strong,{children:`accent color bar`}),` (input) is `,(0,l.jsx)(n.strong,{children:`unique across the entire app`}),`, but specific zones can adapt it (e.g. `,(0,l.jsx)(n.strong,{children:`Euria`}),` → blue).`]}),`
...
`,(0,l.jsxs)(n.ul,{children:[`
`,(0,l.jsxs)(n.li,{children:[`Either keep the component as-is, changing the green for a `,(0,l.jsx)(n.strong,{children:`brand color`}),`.`]}),`
`,(0,l.jsxs)(n.li,{children:[`Or build a `,(0,l.jsx)(n.strong,{children:`fully custom`}),` component (SwiftUI provides all the accessibility parameters for this).`]}),`
`]}),`
