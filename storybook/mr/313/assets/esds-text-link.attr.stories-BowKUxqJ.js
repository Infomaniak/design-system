import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{h as t,n,t as r,u as i}from"./dist-HdtEXM6g.js";import{i as a,o}from"./iframe-CO2cfG8Q.js";import{a as s,i as c,l,n as u,o as d,r as f,s as p,t as m}from"./injectable-style-sheet-AWu4pPpv.js";var h;function g(){return(g=e((()=>{h=`- [Figma ↗](https://www.figma.com/design/OgklXBGhUgpzlYPnVusMpw/Edelweiss---Token-Core?node-id=1473-1429&t=ZWopR2KZ2XXD2MTX-0)
...
## Demo
`})))()}var _;function v(){return(v=e((()=>{_=`[esds-text-link]{color:var(--esds-text-link-content-color-default);text-decoration:none;display:inline}[esds-text-link]:focus-visible{outline:var(--esds-focus-border-width) solid var(--esds-focus-border-color);border-radius:var(--esds-focus-border-radius)}[esds-text-link]:hover,[esds-text-link]:active{color:color-mix(in srgb, rgb(from var(--esds-color-state-hover-strong) r g b / 100%) calc(var(--esds-color-state-hover-strong-a) * 100%), rgb(from var(--esds-text-link-content-color-default) r g b / 100%) calc(var(--esds-text-link-content-color-default-a) * (1 - var(--esds-color-state-hover-strong-a)) * 100%));text-decoration:underline}[esds-text-link]:visited{color:var(--esds-text-link-content-color-visited)}[esds-text-link]:visited:hover,[esds-text-link]:visited:active{color:color-mix(in srgb, rgb(from var(--esds-color-state-hover-medium) r g b / 100%) calc(var(--esds-color-state-hover-medium-a) * 100%), rgb(from var(--esds-text-link-content-color-visited) r g b / 100%) calc(var(--esds-text-link-content-color-visited-a) * (1 - var(--esds-color-state-hover-medium-a)) * 100%))}[esds-text-link][underline]{text-decoration:underline}[esds-text-link][underline]:hover,[esds-text-link][underline]:active{-webkit-text-decoration:initial;text-decoration:initial}`})))()}var y,b;function x(){return(x=e((()=>{u(),s(),v(),y=m.parse(_),b=class e extends c{static define({registry:t=f.root}={}){t.defineOptionally(`esds-text-link`,e)}#e;constructor(e){if(e.ownerElement?.tagName!==`A`)throw Error(`esds-text-link attribute can only be used on <a> elements`);super(e)}connectedCallback(){this.#e=y.injectFrom(this.ownerElement)}disconnectedCallback(){this.#e?.(),this.#e=void 0}}})))()}var S,C,w,T,E,D,O,k,A,j;function M(){return(M=e((()=>{o(),n(),i(),p(),s(),g(),x(),a.define(),S=d(e=>{b.define({registry:f.of(e.ownerDocument)})}),{args:C,argTypes:w}=r(`esds-text-link`),T={title:`Components/Link`,component:`esds-text-link`,tags:[`autodocs`,`vr-test`],parameters:{docs:{description:{component:h}}},args:C,argTypes:w},E={...l({href:`https://infomaniak.com`}),render:e=>t`<a
      ${S}
      esds-text-link
      href="${e.href}"
      >Text link</a
